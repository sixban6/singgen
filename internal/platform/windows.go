...
// WindowsAdapter Linux平台适配器
type WindowsAdapter struct {
	configDir string
}

// NewWindowsAdapter 创建Linux适配器
func NewWindowsAdapter(configDir string) *WindowsAdapter {
...
func (a *WindowsAdapter) GetInboundConfig() ([]map[string]any, error) {
...
// RequiresExternalController Windows需要外部控制器
func (a *WindowsAdapter) RequiresExternalController() bool {
	return true
}
